...
const SignUpPage = () => {
  return (
    <Grid container className="SignUpPage-Component" columns={2} sx={{opacity: 1
    }}>
      <Grid xs={1} sm={1} md={1} container direction='column' rowSpacing={9} sx={{p:3}}>
        <Grid item xs={1 / 2} sm={1 / 2} md={1 / 2} sx={{ p: 3 }}>
          <Logo />
        </Grid>
        <Grid item  sx={{color: "#fafafa"}}>
          <Typography variant="h4" sx={{pb: 4}}>Welcome back!</Typography>
          <Typography>
            To connect with us, please login with your personal info!
          </Typography>
        </Grid>
        <Grid item align='center' xs={1 / 2}>
          <Link to="/si" style={{color: "#fafafa"}}>
