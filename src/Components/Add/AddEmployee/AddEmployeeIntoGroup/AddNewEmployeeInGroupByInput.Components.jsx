...
class AddNewEmployeeInGroupByInput extends React.Component {
  ...
  handleSubmit = async (event) => {
    ...
    const { displayName, email, groupActive, position } = this.state;
  ...
  render() {
    const { displayName, email, position, searchField } = this.state;
        ...
        {selectTriggerSearchAddEmployee ? (
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            >
              ...
              <CustomButton
                type="submit"
                sx={{ position: "relative", left: "25%", mt: 3 }}
              >
                Add Employee
              </CustomButton>
            </Box>
...
export default withRouter(
  connect(mapStateToProps)(AddNewEmployeeInGroupByInput)
);
