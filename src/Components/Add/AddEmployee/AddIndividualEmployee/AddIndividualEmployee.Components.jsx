...
//     const { displayName, email, groupActive, position, currentGroupID } =
//       this.state;
//     try {
...
//   render() {
//     const { displayName, email, position, currentGroupID } = this.state;
...
//                 <CustomButton
//                   type="submit"
//                   sx={{ width: "60%", height: "20%", fontSize: "10px" }}
//                 >
//                   Add Employee
//                 </CustomButton>
//               </>
