...
const OptionBetweenGroupAndIndividual = ({
	toggleOptionBetweenGroupAndIndividual,
}) => {
	return (
		<div onClick={toggleOptionBetweenGroupAndIndividual}>
			<CustomButton>Group and Individual</CustomButton>
		</div>
	);
};
const mapDispatchToProps = (dispatch) => ({
	toggleOptionBetweenGroupAndIndividual: () =>
		dispatch(toggleOptionBetweenGroupAndIndividual()),
});
